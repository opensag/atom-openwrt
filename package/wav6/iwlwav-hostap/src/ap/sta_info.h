...
#define WLAN_STA_VENDOR2_VHT BIT(24)
#define WLAN_STA_HE_OPMODE_ENABLED BIT(25)
#define WLAN_STA_BSS_TRANS_MGMT_REQ_TIMEOUT BIT(26)
#define WLAN_STA_HE BIT(27)
...
#define WLAN_SUPP_CHANNELS_COUNT 50
...
struct sta_info {
	...
	u8 he_capabilities_len_from_sta;
	u8 he_operation_len_from_sta;
