...
struct ieee802_11_elems {
	...
	const u8 *pc_he_capabilities;
	const u8 *pc_he_operation;
	const u8 *pc_he_mu_edca;
	const u8 *pc_he_spatial_reuse_set;
	...
	u8 he_mu_edca_len_from_sta;
	u8 he_spatial_reuse_set_len_from_sta;
