...
/* Data for LTQ_NL80211_VENDOR_SUBCMD_SET_DFS_STATE sub command */
struct intel_vendor_dfs_chandef {
  u32 primary_chan_freq;
  u32 center_freq1;
  u32 center_freq2;
  u8  bandwidth; /* enum nl80211_chan_width */
  u8  dfs_state; /* enum nl80211_dfs_state */
} __attribute__ ((packed));
