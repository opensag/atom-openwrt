...
#define HIM_CHI_N               (NUM_MAN_REQS + NUM_DBG_REQS + NUM_BSS_REQS +\
                                 NUM_MAN_INDS + NUM_DAT_INDS + NUM_DBG_INDS + NUM_BSS_INDS)
...
#define VECTOR_AREA_LOGGER_RD_EXTENSION_ID							(8)
#define VECTOR_AREA_VECTOR_AREA_DEBUG_EXTENSION_ID					(9)  
#define VECTOR_AREA_CARD_CONFIGURATION_EXTENSION_ID					(10)
...
typedef struct
{
	uint16	u16LoggerRdExtensionFirstRdIndex;				/* Which RD is the first Logger RD */
	uint16	u16LoggerRdExtensionNumOfRDs;					/* How many RDs are used by Logger */
} __MTLK_PACKED VECTOR_AREA_LOGGER_RD_EXTENSION_DATA; 


typedef struct
{
	VECTOR_AREA_EXTENSION_HEADER			sHeader;
	VECTOR_AREA_LOGGER_RD_EXTENSION_DATA	sData;
} __MTLK_PACKED VECTOR_AREA_LOGGER_RD_EXTENSION; 
...
typedef struct 
{
    ...
    VECTOR_AREA_LOGGER_BUF_INFO_EXTENSION                   sLoggerBufInfoExt;    
	VECTOR_AREA_FRAGMENTATION_HD_RING_EXTENSION		        sHdFragmentationRingExt;  
	VECTOR_AREA_LOGGER_RD_EXTENSION							sLoggerRdExt;	
...
#define G6_USER_SPEC_PRE_PPDU_PHY_STAT2_0_VHT_NSS     MTLK_BFIELD_INFO(24, 4) /* VHT NSS */
#define G6_USER_SPEC_PRE_PPDU_PHY_STAT2_0_VHT_MCS     MTLK_BFIELD_INFO(28, 3) /* VHT MCS */
