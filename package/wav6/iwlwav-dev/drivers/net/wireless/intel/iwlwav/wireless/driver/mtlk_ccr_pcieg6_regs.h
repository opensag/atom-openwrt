...
#define MTLK_G6_URAM_IRAM_START     (CPU_IRAM_OFFSET_FROM_BAR0)
#define MTLK_G6_URAM_IRAM_SIZE      (CPU_IRAM_SIZE)

#define MTLK_G6_IFCPU_IRAM_START    (MAC_GENRISC_HOST_IRAM_OFFSET_FROM_BAR0)
#define MTLK_G6_IFCPU_IRAM_SIZE     (MAC_GENRISC_HOST_IRAM_SIZE)

#define MTLK_G6_B0_TXCPU_IRAM_START (B0_MAC_GENRISC_TX_IRAM_OFFSET_FROM_BAR0)
#define MTLK_G6_B0_TXCPU_IRAM_SIZE  (B0_MAC_GENRISC_TX_IRAM_SIZE)
#define MTLK_G6_B1_TXCPU_IRAM_START (B1_MAC_GENRISC_TX_IRAM_OFFSET_FROM_BAR0)
#define MTLK_G6_B1_TXCPU_IRAM_SIZE  (B1_MAC_GENRISC_TX_IRAM_SIZE)

#define MTLK_G6_B0_RXCPU_IRAM_START (B0_MAC_GENRISC_RX_IRAM_OFFSET_FROM_BAR0)
#define MTLK_G6_B0_RXCPU_IRAM_SIZE  (B0_MAC_GENRISC_RX_IRAM_SIZE)
#define MTLK_G6_B1_RXCPU_IRAM_START (B1_MAC_GENRISC_RX_IRAM_OFFSET_FROM_BAR0)
#define MTLK_G6_B1_RXCPU_IRAM_SIZE  (B1_MAC_GENRISC_RX_IRAM_SIZE)
...
#define PCIE_CFG_REGS_BAR0          (PCIE_REGBLOCK_OFFSET_FROM_BAR0)
