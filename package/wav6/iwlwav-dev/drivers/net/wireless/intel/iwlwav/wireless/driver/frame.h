...
typedef struct {
  ...
  uint16    beacon_interval;
  // From IEs
  uint8     essid[BSS_ESSID_MAX_SIZE+1];    /* Null terminated string */
...
uint32  mtlk_frame_oper_rateset_to_net_mode(uint32 oper_rateset, BOOL is_ht, BOOL is_vht, BOOL is_he);
