...
#define IWLWAV_RTLOG_HW_FIFOS_G5       6 /* Gen5 */
#define IWLWAV_RTLOG_HW_FIFOS_G6      16 /* Gen6 */
#define IWLWAV_RTLOG_HW_FIFOS_MIN     MIN(IWLWAV_RTLOG_HW_FIFOS_G5, IWLWAV_RTLOG_HW_FIFOS_G6)
#define IWLWAV_RTLOG_HW_FIFOS         MAX(IWLWAV_RTLOG_HW_FIFOS_G5, IWLWAV_RTLOG_HW_FIFOS_G6)
