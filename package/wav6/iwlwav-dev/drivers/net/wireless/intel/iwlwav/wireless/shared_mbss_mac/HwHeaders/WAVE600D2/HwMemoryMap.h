/***********************************************************************************
File:				HwMemoryMap.h
Module:				Hw Headers - wave600_memory_map_ver2.10.0.xlsx
Purpose:
...
#define HOST_IF_ACC_BASE_ADDR                                                  (0xA0250000)
#define HOST_IF_REG_FILE_BASE_ADDR                                             (0xA0251000)
#define BEST_RU_DB_BASE_ADDR                                                   (0xA0258000)
...
#define PCIE_REGBLOCK_BASE_ADDR                                                (0xA0278000)
#define PVT_BLOCK_BASE_ADDR                                                    (0xA0280000)
...
#define RX_PP_BASE_ADDR                                                        (0xA02A0000)
#define RX_PP_REGS_BASE_ADDR                                                   (0xA02AF800)
#define DATA_LOGGER_BASE_ADDR                                                  (0xA02B0000)
...
#define BA_ANALYZER_COUNTER_BASE_ADDR                                          (0xA0780000)
#define RX_PP_COUNTERS_BASE_ADDR                                               (0xA07A0000)
#define RX_COORDINATOR_COUNTERS_BASE_ADDR                                      (0xA07B0000)
#define HOST_IF_COUNTERS_BASE_ADDR                                             (0xA07C0000)
#define HOST_IF_QOS_COUNTERS_BASE_ADDR                                         (0xA07D0000)
...
#define B0_RF_EMULATOR_BASE_ADDR                                               (0xA0B6F000)
#define B1_RF_EMULATOR_BASE_ADDR                                               (0xA0F6F000)
...
#define HOST_IF_ACC_OFFSET_FROM_BAR0                                           (0x00250000)
#define HOST_IF_REG_FILE_OFFSET_FROM_BAR0                                      (0x00251000)
#define BEST_RU_DB_OFFSET_FROM_BAR0                                            (0x00258000)
...
#define PCIE_REGBLOCK_OFFSET_FROM_BAR0                                         (0x00278000)
#define PVT_BLOCK_OFFSET_FROM_BAR0                                             (0x00280000)
...
#define RX_PP_OFFSET_FROM_BAR0                                                 (0x002A0000)
#define RX_PP_REGS_OFFSET_FROM_BAR0                                            (0x002AF800)
...
#define BA_ANALYZER_COUNTER_OFFSET_FROM_BAR0                                   (0x00780000)
#define RX_PP_COUNTERS_OFFSET_FROM_BAR0                                        (0x007A0000)
#define RX_COORDINATOR_COUNTERS_OFFSET_FROM_BAR0                               (0x007B0000)
#define HOST_IF_COUNTERS_OFFSET_FROM_BAR0                                      (0x007C0000)
#define HOST_IF_QOS_COUNTERS_OFFSET_FROM_BAR0                                  (0x007D0000)
...
#define B0_RF_EMULATOR_OFFSET_FROM_BAR0                                        (0x00B6F000)
#define B1_RF_EMULATOR_OFFSET_FROM_BAR0                                        (0x00F6F000)
...
#define PCIE_REGBLOCK_SIZE                                                     (0x00008000)
...
#define REDUCED_DESCRIPTOR_RAM_SIZE                                            (0x00080000)
 ...
 /* auto generated from wave600_rams_by_modules_ver2.10.0.xlsm, sheet gen6_wlanip_rams_by_modules */
...
#define HYP_RXFD_SHARED_SU_PHASES_MEMORY_LO_1                                  (B0_PHY_RX_FD_BASE_ADDR + 0x00028000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define HYP_RXFD_SHARED_SU_PHASES_MEMORY_HI_0                                  (B0_PHY_RX_FD_BASE_ADDR + 0x00030000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define HYP_RXFD_SHARED_SU_PHASES_MEMORY_HI_1                                  (B0_PHY_RX_FD_BASE_ADDR + 0x00038000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
...
#define B0_SMOOTH_INTERP_CONTROL_PATH_USER_RU_MAP_RAM                          (B0_PHY_RX_FD_BASE_ADDR + 0x0000E400) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define B1_SMOOTH_INTERP_CONTROL_PATH_USER_RU_MAP_RAM                          (B1_PHY_RX_FD_BASE_ADDR + 0x0000E400) /* MEMORY_MAP_UNIT_10051_BASE_ADDRESS */
#define B0_HYP_RXFD_CSM_RCR_RAM                                                (B0_PHY_RX_FD_BASE_ADDR + 0x0000E000) /* MEMORY_MAP_UNIT_51_BASE_ADDRESS */
#define B1_HYP_RXFD_CSM_RCR_RAM                                                (B1_PHY_RX_FD_BASE_ADDR + 0x0000E000) /* MEMORY_MAP_UNIT_10051_BASE_ADDRESS */
...
#define B1_BESTRU_SCRATCH_MEM_WRAP_BESTRU_SCRATCH_MEM                          (B0_BESTRU_BASE_ADDR + 0x00000100) /* MEMORY_MAP_UNIT_66_BASE_ADDRESS */
#define BESTRU_DB_RAM_WRAP_SHARED_BESTRU_DB_MEM                                (BEST_RU_DB_BASE_ADDR + 0x00000000) /* MEMORY_MAP_UNIT_1038_BASE_ADDRESS */
#define B0_RX_SIGB_SIGB_RAM_CDB0                                               (B0_PHY_RX_BE_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_49_BASE_ADDRESS */
#define B1_RX_SIGB_SIGB_RAM_CDB1                                               (B0_PHY_RX_BE_BASE_ADDR + 0x00010000) /* MEMORY_MAP_UNIT_49_BASE_ADDRESS */
#define HYP_TD_ANTENNA_ZWDFS_BAND_SEL_COEF                                     (B0_PHY_RX_TD_BASE_ADDR + 0x00022000) /* MEMORY_MAP_UNIT_50_BASE_ADDRESS */
#define HYP_TD_ANTENNA_ZWDFS_IQ_PARAMS_LUT                                     (B0_PHY_RX_TD_BASE_ADDR + 0x00022400) /* MEMORY_MAP_UNIT_50_BASE_ADDRESS */
#define HYP_TD_ANTENNA_ZWDFS_IQ_FIREQ_LUT                                      (B0_PHY_RX_TD_BASE_ADDR + 0x00022800) /* MEMORY_MAP_UNIT_50_BASE_ADDRESS */
