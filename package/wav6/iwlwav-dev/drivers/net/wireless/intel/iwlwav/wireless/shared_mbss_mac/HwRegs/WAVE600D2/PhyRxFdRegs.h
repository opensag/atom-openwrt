...
typedef union
{
	...
	struct
	{
		uint32 noiseGainMax : 9; //First symbol max noise gain, reset value: 0x, access type: RO
		uint32 reserved0 : 7;
		uint32 noiseGainBinNum : 11; //Number of bins accumulated for noise gain sum, reset value: 0x, access type: RO
		uint32 reserved1 : 5;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 noiseGainSum : 20; //Accumulated noise gain during first symbol, reset value: 0x, access type: RO
		uint32 reserved0 : 12;
	} bitFields;
