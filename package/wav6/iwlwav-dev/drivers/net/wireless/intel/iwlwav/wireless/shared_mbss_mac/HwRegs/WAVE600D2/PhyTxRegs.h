...
#define	REG_PHY_TX_TXTD_SCALE_HEEXT_LLTF_20        (PHY_TX_BASE_ADDRESS + 0xFA0)
#define	REG_PHY_TX_TXTD_SCALE_HEEXT_HELTF_10       (PHY_TX_BASE_ADDRESS + 0xFA4)
...
/*REG_PHY_TX_TXTD_SCALE_HEEXT_LLTF_20 0xFA0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 txtdScaleHeextLltf20 : 12; //no description, reset value: 0x0, access type: RW
		uint32 reserved0 : 20;
	} bitFields;
} RegPhyTxTxtdScaleHeextLltf20_u;

/*REG_PHY_TX_TXTD_SCALE_HEEXT_HELTF_10 0xFA4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 txtdScaleHeextHeltf10 : 12; //no description, reset value: 0x0, access type: RW
		uint32 reserved0 : 20;
	} bitFields;
} RegPhyTxTxtdScaleHeextHeltf10_u;
