...
*
**************************************************************************************/
#ifndef _STATISTICS_DESC_WAVE600_H_
#define _STATISTICS_DESC_WAVE600_H_
...
#else
}  HostIfCountersPerVap_t_wave600;
#endif
...
#else
} HostIfCountersPerSta_t_wave600;
#endif
...
#else
	HostIfCountersPerVap_t_wave600 	vapCounts[HW_NUM_OF_VAPS];
	HostIfCountersPerSta_t_wave600 	staCounts[HW_NUM_OF_STATIONS];
#endif
#ifdef CPU_ARC
} HostIfCounters_t;
#else
} HostIfCounters_t_wave600;
#endif
...
#else
} RxCountersRxppPerVap_t_wave600;
#endif
...
#else
	RxCountersPerVap_t_wave600 	vapCounts[HW_NUM_OF_VAPS];
#endif
...
#else
	RxCountersPerSta_t_wave600 		staCounts[HW_NUM_OF_STATIONS];
	RxCountersRxppPerVap_t_wave600 	rxppVapCounts[HW_NUM_OF_VAPS];
	RxCountersPerBand_t_wave600 	bandCounts[GEN6_NUM_OF_BANDS];
#endif
#ifdef CPU_ARC
} RxCounters_t;
#else
} RxCounters_t_wave600;
#endif
...
#else
} BaaCountersRetryPerBand_t_wave600;
#endif
...
#else
	BaaCountersRetryPerBand_t_wave600 	retryCounts[GEN6_NUM_OF_BANDS];
	BaaCountersPerVap_t_wave600	 		vapCounts[HW_NUM_OF_VAPS];
	BaaCountersPerSta_t_wave600 		staCounts[HW_NUM_OF_STATIONS];
#endif
...
#else
} TsManagerInitiatorTidGlobalStatistics_t_wave600;
#endif
...
#else
} TsManagerInitiatorStationGlobalStatistics_t_wave600;
#endif
...
#else
} TsManagerRecipientTidGlobalStatistics_t_wave600;
#endif
...
#else
} TsManagerRecipientStationGlobalStatistics_t_wave600;
#endif
...
typedef struct 
{
	...
	uint32 rxDc[MAX(NUM_OF_BW, PHY_STATISTICS_MAX_RX_ANT)];
	uint32 txLo[MAX(NUM_OF_BW, PHY_STATISTICS_MAX_RX_ANT)];
	uint32 rxIq[MAX(NUM_OF_BW, PHY_STATISTICS_MAX_RX_ANT)];
	uint32 txIq[MAX(NUM_OF_BW, PHY_STATISTICS_MAX_RX_ANT)];
...
#else
} LinkAdaptationStatistics_t_wave600;
#endif
...
#else
} TrainingManagerStatistics_t_wave600;
#endif
...
#else
} GroupManagerStatistics_t_wave600;
#endif
...
#else
} LinkAdaptationMuStatistics_t_wave600;
#endif
...
#else
} AlphaFilterStatistics_t_wave600;
#endif
...
#else
	chUtilization_t_wave600 	channelUtilizationStats[GEN6_NUM_OF_BANDS];
#endif
	int8		channelMax80211Rssi[GEN6_NUM_OF_BANDS];	
#ifdef CPU_ARC
} channelStatistics_t;
#else
} channelStatistics_t_wave600;
#endif
...
#else
	rssiSnapshot_t_wave600	rssiAckAvarage; //AP_MODE: RSSI from last 4 ack received
#endif	
	uint16	psduRate;						/* PSDU RATE is copied from phy metrics. It is constructed from MCS, NSS and BW */
...
#else
} stationPhyRxStatusDb_t_wave600;
#endif
...
#else
	devicePhyRxStatusDb_t_wave600 	devicePhyRxStatus[GEN6_NUM_OF_BANDS];
	stationPhyRxStatusDb_t_wave600	staPhyRxStatus[HW_NUM_OF_STATIONS];
#endif
#ifdef CPU_ARC
} wholePhyRxStatusDb_t;
#else
} wholePhyRxStatusDb_t_wave600;
#endif
...
#else
typedef struct _StatisticsDb_t_wave600
{
	HostIfCounters_t_wave600 							hostIfCounters;
	RxCounters_t_wave600								rxCounters;
	BaaCounters_t_wave600								baaCounters;
	TsManagerInitiatorTidGlobalStatistics_t_wave600		tsManagerInitiatorTidGlobalStats;
	TsManagerInitiatorStationGlobalStatistics_t_wave600	tsManagerInitiatorStationGlobalStats;
	TsManagerRecipientTidGlobalStatistics_t_wave600		tsManagerRecipientTidGlobalStats;
	TsManagerRecipientStationGlobalStatistics_t_wave600	tsManagerRecipientStationGlobalStats;
	LinkAdaptationStatistics_t_wave600					linkAdaptationStats;
	MulticastStatistics_t_wave600						multicastStats;
	TrainingManagerStatistics_t_wave600					trainingManagerStats;
	GroupManagerStatistics_t_wave600					groupManagerStats;
	LinkAdaptationMuStatistics_t_wave600				linkAdaptationMuStats;
	PtaStatistics_t_wave600								ptaStats;
	TwtStatistics_t_wave600								twtStats;
	PerClientStatistics_t_wave600						perClientStats;
	GeneralStatistics_t_wave600							generalStats;
	DynamicBwStatistics_t_wave600						dynamicBwStats;
	wholePhyRxStatusDb_t_wave600						phyStatistics;
	channelStatistics_t_wave600 						currentChannelStats;
} StatisticsDb_t_wave600;
#endif

#endif //_STATISTICS_DESC_WAVE600_H_
