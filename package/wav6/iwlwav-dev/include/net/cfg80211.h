...
struct ieee80211_supported_band {
	...
	struct ieee80211_sta_he_cap_iwlwav he_cap;
	u16 n_iftype_data;
...
struct station_parameters {
	...
	const struct ieee80211_he_cap *he_capa_iwlwav;
	const struct ieee80211_he_operation *he_oper_iwlwav;
	u8 uapsd_queues;
	u8 max_sp;
...
bool cfg80211_rx_mgmt(struct wireless_dev *wdev, int freq, int sig_dbm,
				int snr_db, const u8 *buf, size_t len, u32 flags);
