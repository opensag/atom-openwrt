...
static int handle_iwlwav_set_long_retry_limit(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_LONG_RETRY_LIMIT);
}
COMMAND(iwlwav, sLongRetryLimit, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_long_retry_limit, "");
...
static int handle_iwlwav_set_hidden_ssid(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_HIDDEN_SSID);
}
COMMAND(iwlwav, sHiddenSSID, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_hidden_ssid, "");
...
static int handle_iwlwav_set_txop_config(struct nl80211_state *state,
                                          ...
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 2, 2, LTQ_NL80211_VENDOR_SUBCMD_SET_TXOP_CONFIG);
}
...
static int handle_iwlwav_set_short_cycle_prfx(struct nl80211_state *state,
                                          struct nl_msg *msg,
                                          int argc, char **argv,
                                          enum id_input id)
{
	return set_int(state, msg, argc, argv, id, 1, 1, LTQ_NL80211_VENDOR_SUBCMD_SET_USE_SHORT_CYCLIC_PREFIX);
}
COMMAND(iwlwav, sShortCyclcPrfx, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_set_short_cycle_prfx, "");
...
static int handle_iwlwav_get_long_retry_limit(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_LONG_RETRY_LIMIT, 1, "gLongRetryLimit");
}
COMMAND(iwlwav, gLongRetryLimit, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_long_retry_limit, "");
...
static int handle_iwlwav_get_hidden_ssid(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_HIDDEN_SSID, 1, "gHiddenSSID");
}
COMMAND(iwlwav, gHiddenSSID, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_hidden_ssid, "");
...
static int handle_iwlwav_get_txop_config(struct nl80211_state *state,
			      ...
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_TXOP_CONFIG, 2, "gTxopConfig");
}
...
static int handle_iwlwav_get_short_cyclc_prfx(struct nl80211_state *state,
			      struct nl_msg *msg, int argc,
			      char **argv, enum id_input id)
{
	return sub_cmd_print_int_function(state, msg, argc, argv, id, LTQ_NL80211_VENDOR_SUBCMD_GET_USE_SHORT_CYCLIC_PREFIX, 1, "gShortCyclcPrfx");
}
COMMAND(iwlwav, gShortCyclcPrfx, "", NL80211_CMD_VENDOR, 0, CIB_NETDEV, handle_iwlwav_get_short_cyclc_prfx, "");
...
static int handle_iwlwav_help(struct nl80211_state *state,
			      ...
			      char **argv, enum id_input id)
{
	printf("\tdev <devname> iwlwav sLongRetryLimit <long retry limit>\n");
	printf("\t\tSet long retry limit.\n\n");
	...
	printf("\tdev <devname> iwlwav sHiddenSSID <hidden SSID>\n");
	printf("\t\tSet hidden SSID.\n\n");
	...
	printf("\tdev <devname> iwlwav sTxopConfig <staId> <mode>\n");
	...
	printf("\tdev <devname> iwlwav sShortCyclcPrfx <cycle prefix>\n");
	printf("\t\tSet short cycle prefix.\n\n");
	...
	printf("\tdev <devname> iwlwav gLongRetryLimit\n\n");
	...
	printf("\tdev <devname> iwlwav gHiddenSSID\n\n");
	...
	printf("\tdev <devname> iwlwav gShortCyclcPrfx\n\n");
